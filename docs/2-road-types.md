...
<table class="">
	<tr>
		<td>
			<img src="assets/2-road-types/2-1-1-Right.png">
		</td>
		<td>
			<img src="assets/2-road-types/2-1-2-TurnLeft.png">
		</td>
		<td>
	...
	<tr>
		...
		<td>
			<p class="caption">Ілюстрація&nbsp;2.2&nbsp;&mdash; З&rsquo;їзд ліворуч на&nbsp;прикладі <span class="road-num t">Т</span>-подібного перехрестя доріг категорії <span class="road-num t">Т</span></p>
		</td>
		<td>
...
<p class="caption">Ілюстрація 2.1 — З’їзд праворуч на прикладі розгалудження доріг категорій <span class="road-num n"><span class="road-num n">Н</span></span> та <span class="road-num t"><span class="road-num t">Т</span></span></p>
<p class="caption">Ілюстрація 2.3 — З’їзд ліворуч на прикладі <span class="road-num t">Т</span>-подібного перехрестя доріг категорії <span class="road-num t">Т</span></p>
<p class="caption">Ілюстрація 2.4 — З’їзд праворуч на прикладі примикання доріг категорій <span class="road-num m">М</span> та О</p>
 -->
...
Знаки підтвердження (5.59 «Покажчик відстаней») вказують, до яких населених пунктів можна дістатись, рухаючись вперед. Їх встановлюють на дорогах з індексом <span class="road-num t">Т</span>, Р, <span class="road-num n">Н</span> та <span class="road-num m">М</span> за 400 м після з’їзду поза населеними пунктами та за 50–150 м у населених пунктах.
...
![2-2-Xсross.png](assets/2-road-types/2-2-Xсross.png "")
...
![2-3-1-Clover.png](assets/2-road-types/2-3-1-Clover.png "")
![2-3-2-Roundabout.png](assets/2-road-types/2-3-2-Roundabout.png "")
![2-3-3-Uturn.png](assets/2-road-types/2-3-3-Uturn.png "")
...
![2-5-1-Entrance.png](assets/2-road-types/2-5-1-Entrance.png "")
![2-5-2-Entrance.png](assets/2-road-types/2-5-2-Entrance.png "")
...
![2-6-City.png](assets/2-road-types/2-6-City.png "")
...
![2-7-1-End.png](assets/2-road-types/2-7-1-End.png "")
![2-7-2-End.png](assets/2-road-types/2-7-2-End.png "")
...
Знаки підтвердження (5.59 «Покажчик відстаней») вказують, до яких населених пунктів можна дістатись, рухаючись вперед. Їх встановлюють на дорогах з індексом <span class="road-num t">Т</span>, Р, <span class="road-num n">Н</span> та <span class="road-num m">М</span> за 400 м після виїзду з населеного пункту.
