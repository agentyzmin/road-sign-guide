...
2.1.1 Щоб реалізувати принцип людиноорієнтованості, системи маршрутного орієнтування проєктують, опираючись на цілісні маршрути. Для водія маршрут має початок і кінець та велику кількість _точок ухвалення рішень (ТУР)_ між ними (ілюстрація 2.1). Отож, будь-яке перехрещення доріг, розв’язку чи іншу ділянку траси ми розглядаємо від першої особи, з точки зору водія. Це ситуації на маршруті, в яких водієві потрібно прийняти коректні рішення.

![alt_text](images/image1.png "image_tooltip")

Малюнок 2.1 — Цілісний маршрут
