...
<p class="caption">Ілюстрація 5.1 — Будова знаків напрямку з одним напрямком</p>
...
<p class="caption">Ілюстрація 5.4 — Приклад знаків з кількома напрямками</p>
...
<p class="caption">Ілюстрація 5.8 — Знак з’їзду (праворуч) поруч зі знаками руху прямо</p>
...
<p class="caption">Ілюстрація 5.9 — Будова знака з’їзду з дороги</p>
...
<p class="caption">Ілюстрація 5.10 — Комбінування різних знаків на одній опорі</p>
...
<p class="caption">Ілюстрація 5.11 — </p>
...
<p class="caption">Ілюстрація 5.19 — Попереду три дестинації: Решетилівка, Київ та Полтава</p>
...
<p class="caption">Ілюстрація 5.21  — Реальний маневр роз’їзду та спрощений маневр на схемі</p>
...
<p class="caption">Ілюстрація 5.22 — Приклад підписів напрямків, які роблять помилки водія можливими</p>
...
<p class="caption">Ілюстрація 5.24 — Рознесені напрямки в три різні сторони</p>
...
<p class="caption">Ілюстрація 5.25 — Виділення головної дороги більшою товщиною лінії</p>
...
<p class="caption">Ілюстрація 5.26 — Розв’язка близька формою до ромбу</p>
...
<p class="caption">Ілюстрація 5.27 — Розміри великої та малої стрілки</p>
...
<p class="caption">Ілюстрація 5.28 — Відстань розміщення тексту з кожного боку стрілки</p>
...
<p class="caption">Ілюстрація 5.29 — Розташування тексту напрямку прямо (над стрілкою та поруч зі стрілкою)</p>
...
<p class="caption">Ілюстрація 5.30 — Приклад розв'язки «конюшина» з використанням перетину</p>
...
<p class="caption">Ілюстрація 5.31 — Будова перетину</p>
...
<p class="caption">Ілюстрація 5.32 — Приклад </p>
...
<p class="caption">Ілюстрація 5.33 — Комбінування кольорів тла</p>
...
<p class="caption">Ілюстрація 5.34 — Схема розташована в межах населеного пункту, на якій у напрямку прямо заборонено пересування вантажівок</p>
...
<p class="caption">Ілюстрація 5.36 — </p>
...
<p class="caption">Ілюстрація 5.35 — Поворот праворуч та розворот</p>
...
<p class="caption">Ілюстрація 5.36 — З’їзд та розгалуження дороги з проїздом під шляхопроводом</p>
...
<p class="caption">Ілюстрація 5.37 — Повороти ліворуч та праворуч на «конюшині»</p>
...
<p class="caption">Ілюстрація 5.38 — Розворот та віднесений поворот ліворуч</p>
...
<p class="caption">Ілюстрація 5.39 — Схема з вказаною відстанню до маневру</p>
...
<p class="caption">Ілюстрація 5.40  — Розташування на знаку позначки відстані відносно країв, ліній і написів</p>
...
<p class="caption">Ілюстрація 5.41 — Приклад знаку підтвердження. На знаку: дорога, якою прямуємо — Н31; наступний населений пункт по дорозі — Петриківка; термінальний населений пункт (кінцевий на цій дорозі) — Дніпро; Донецьк в тому ж напрямку, але потрібно буде з’їхати на М04</p>
...
<p class="caption">Ілюстрація 5.42 — Будова знака підтвердження</p>
...
<p class="caption">Ілюстрація 5.43 — Розміщення кількох номерів вгорі знака, відступи праворуч і ліворуч однакові</p>

<span class="p-number">5.6.2</span> Принципи вибору дестинацій. На одному знаку вказують не більше трьох дестинацій і відстані до них. На дорогах типу Т і Р, відповідно до цих правил, встановлюють по одному такому знаку. На дорогах з індексом Н і М — по два.

<span class="p-number">5.6.3</span> Два знаки підтвердження на дорогах Н і М встановлюють за необхідності, якщо дестинацій, відповідних правилам, попереду більше ніж три (ілюстрація 9.3.1).
...
<p class="caption">Ілюстрація 5.44 — Два знаки підтвердження</p>
...
<p class="caption">Ілюстрація 5.45 — Один знак підтвердження</p>
...
![Знак 5.45](assets/5-sign-design/5.45.png "Знак 5.45")
![Знак 5.46](assets/5-sign-design/5.46.png "Знак 5.46")

<p class="caption">Ілюстрація 5.46 — Будова знаків 5.45 та 5.46</p>



![Знак 5.47](assets/5-sign-design/5.47.png "Знак 5.47")
![Знак 5.48](assets/5-sign-design/5.48.png "Знак 5.48")


<p class="caption">Ілюстрація 5.47 — Будова знаків 5.46 та 5.47</p>
...
<p class="caption">Ілюстрація 5.48 — Вигляд знака позначення річки</p>
...
<p class="caption">Ілюстрація 5.49 — Будова хвилі</p>
...
<p class="caption">Ілюстрація 5.49 — Заборонена трансформація хвиль</p>
...
<p class="caption">Ілюстрація 5.50 — Приклади інформаційних панно</p>
...
<p class="caption">Ілюстрація 5.51 — Знак попередження про розворот зустрічного транспорту</p>
...
<p class="caption">Ілюстрація 5.52 — Приклад зміни інформаційний панно: інформація та сама, а подача інша</p>
...
<p class="caption">Ілюстрація 5.53 — Знак на межі району</p>
...
<p class="caption">Ілюстрація 5.54 — Населений пункт зі вказаним районом</p>
...
<p class="caption">Ілюстрація 5.55 –– Надання відстаней на знаках сервісу</p>
